...
First need to provision multiple (2) instances where the notebooks will be ran and utilize multinode training. This parrallelism will help with training deep learning models with large datasets at a faster rate.
