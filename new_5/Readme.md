...
# Homework 5 - Training a Deep Learning Model on AWS with PyTorch and Imagenet
...
* Spin up g4dn.2xlarge instance with 1TB root volumn
* Download the corrosponding Imagenet datasets onto the EC2 instance
* Run the "validation_setup.sh" and "train_setup.sh" in the respective folders to prepare the datasets
* Clone the w251 (this repo) onto the instance
* Spin up PyTorch Docker image containing required libraries and mount the /data folder and /w251/HW5 to the Docker image (using below command)
* Run all of the cells in the imagenet_dl.ipynb file to start the model training
* Done!